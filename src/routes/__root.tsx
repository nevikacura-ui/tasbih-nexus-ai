...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A calm, AI-powered spiritual companion and community for modern Muslim youth and families." },
      { property: "og:title", content: "Tasbih.ai" },
      { property: "og:description", content: "Remember. Reflect. Seek Noor." },
